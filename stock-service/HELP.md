...
* The original package name 'com.example.stock service' is invalid and this project uses 'com.example.stock.service' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/docs/3.1.7/reference/htmlsingle/index.html#messaging.kafka)
